...
### Method 2
We have fit a simple linear regression model to the data to try and determine how our factors may be impacting fruit yield. For this model, y is the response variable (harvest amount) and x~1~ and x~2~ are our covariate factors (tree elevation, and year planted).
...
Using our model statement, we have run a linear model to determine if any of our covariates are significantly impacting harvest amounts.
...
### Third Analysis
```{r third-analysis, warning=FALSE}
